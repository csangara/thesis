...
def main():
    ...
    prs.add_argument('-r', '--regression_model', default = None,
                     type = str, help = 'name of regression model')
    ...
    if args.regression_model is None:
        regression_model_output = os.listdir(results_folder + "/regression_model")[0]
    else:
        regression_model_output = args.regression_model
